<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Registro.aspx.vb" Inherits="TCC.Registro1" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Button id="btnCadastrar" type="submit" Text="Cadastrar" runat="server"></asp:Button>
    </form>
</body>
</html>
